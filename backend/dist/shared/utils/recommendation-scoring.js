...
exports.computeFinalScore = exports.computeCompositeScore = exports.computeDiversityScore = exports.computeEmotionalSimilarity = void 0;
/**
 ...
 */
const computeEmotionalSimilarity = (userState, albumEmbedding) => {
    const dimensions = Object.keys(userState);
    let dotProduct = 0;
    let userMagnitude = 0;
...
exports.computeEmotionalSimilarity = computeEmotionalSimilarity;
/**
 ...
 */
const computeDiversityScore = (artist, selectedAlbums) => {
    if (selectedAlbums.length === 0)
        return 1.0; // First album is maximally diverse
    // Count how many albums by same artist already selected
    const sameArtistCount = selectedAlbums.filter(a => a.artist.toLowerCase() === artist.toLowerCase()).length;
    // Penalty: 0.8, 0.5, 0.2, 0.0 for 1st, 2nd, 3rd, 4th+ duplicate artists
    const penaltyFactor = Math.pow(0.8, sameArtistCount);
    return penaltyFactor;
};
exports.computeDiversityScore = computeDiversityScore;
/**
 ...
 */
const computeCompositeScore = (emotionalScore, historyScore, noveltyScore) => {
 ...
 */
const computeFinalScore = (compositeScore, diversityScore) => {
    return 0.9 * compositeScore + 0.1 * diversityScore;
};
exports.computeFinalScore = computeFinalScore;
//# sourceMappingURL=recommendation-scoring.js.map