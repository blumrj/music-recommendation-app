...
class AlbumController {
    ...
    async getFavorites(req, res) {
        try {
            ...
            const favorites = await albums_service_1.albumService.getUserFavorites(userId);
    ...
    async saveFavorite(req, res) {
        try {
            ...
            const favorite = await albums_service_1.albumService.saveFavorite({
                userId,
                albumSpotifyId,
                albumName,
                artist,
    ...
    async removeFavorite(req, res) {
        try {
            ...
            await albums_service_1.albumService.removeFavorite(userId, spotifyId);
