 ...
 */
router.get("/favorites/all", authMiddleware, (req, res) =>
  albumController.getFavorites(req, res)
);
 ...
 * }
 */
router.post("/favorites/save", authMiddleware, (req, res) =>
  albumController.saveFavorite(req, res)
);
 ...
 * Authorization: Bearer <jwt_token>
 */
router.delete("/favorites/:spotifyId", authMiddleware, (req, res) =>
  albumController.removeFavorite(req, res)
);
